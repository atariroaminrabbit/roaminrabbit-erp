...
// - expiryDate is reserved for future use and must NOT be rendered in UI
// - Order ID format: RR-YYYYMMDD-XXX (XXX = nth order placed that day)
// - Grant ID format: GRT-XXX (links to CoinGrant.id in coinGrants.ts)
...
export const coinTransactions: CoinTransaction[] = [
  ...
  // RRID-0012 (Lin Hui) — 1 purchase, just started earning
  {
    ...
    amount: 0.60,
    referenceType: 'order',
    referenceId: 'RR-20260322-001',
    timestamp: '2026-03-22T09:00:00Z',
    balanceAfter: 0.60,
    expiryDate: null,
  },

  // Granted transactions — manual coin grants approved by admins
  {
    id: 'TXN-0023',
    userId: 'RRID-0001',
    type: 'granted',
